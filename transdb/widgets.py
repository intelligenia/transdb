...
class TransCharWidget(Widget):
    ...
    def render(self, name, value, attrs=None):
        ...
        for lang_code, lang_name in settings.LANGUAGES:
            ...
            output.append('<li style="list-style-type: none; float: left; margin-right: 1em;"><span style="display: block;" class="minititle">%s:</span>%s</li>' % (force_unicode(lang_name), input))
